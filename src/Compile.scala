...
.method public static writestr(java.lang.String;)V
    .limit locals 1
    .limit stack 2
...
//          "invokestatic XXX/XXX/write(I)V\n"), env)
      ...
      case WriteStr(str) =>
        (List("iload " + str + "\n" +
          "invokestatic XXX/XXX/writestr(I)V\n"), env)
      ...
      case For(a, int, bl) => {
        ...
        (List("\n" + loop_begin + ":\n\n") ++
          compile_bexp(Bop("<=", a.a, int), env, loop_end) ++
          instrs1 ++
          List("goto " + loop_begin + "\n") ++
          List("\n" + loop_end + ":\n\n"), env1)
      }
...
//  def tokenToStmt(tokenList: List[(String, String)]) : List[Stmt] {
//
//  }
